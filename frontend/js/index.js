...
console.log(":::User in Index.js:::", window.userRole);
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadPage(page) {
    ...
    if (page == "Add_Book") {
      let book;
      console.log("Add_Book page loaded");
      ...
      if (addBtn) {
        addBtn.addEventListener("click", async () => {
          ...
          const pub_location = document.getElementById("Pub_location").value;
      ...
      if (userRole == "librarian") {
        ...
        if (excelFileBtn) {
          excelFileBtn.addEventListener("click", async () => {
            console.log("Excel file selector clicked");
    ...
    if (page == "Books") {
      ...
      window.BOOKS.seeTotalBooks().then((res) => {
        ...
        console.log("All_Books", res.All_books);
        ...
        if (res.success) {
          ...
          // console.log("☯️Calling Display Books");
          // console.log(res.All_books);
          displayBooks(res.All_books.slice(0, 50));
          console.log("🤙Calling Search Books");
      ...
      next.addEventListener("click", function () {
        ...
        if (next_sib) {
          ...
          showMessage("error", "No More Data", "No More Data To Display");
        }
      });
      ...
      if (add_stu_btn) {
        add_stu_btn.addEventListener("click", (e) => {
          ...
          window.BOOKS.addStudent(student).then((res) => {
            if (!res.success) {
              console.log("Error Occurred While Adding Student :", res.error);
              showMessage(
                "error",
    ...
    if (page == "Students") {
      if (userRole == "librarian") {
        window.BOOKS.getStudents().then((res) => {
          ...
          if (!res.success) {
            console.log("Database Error:", res.error);
            setTimeout(() => {
              showMessage(
                "error",
                "Database Error",
          ...
          console.log("DATA Sended to displayStudents ::::::::::\n");
    ...
    if (page == "Issue_Book") {
      if (userRole == "librarian") {
        console.log("Issue_Book Clicked :::::");
        setDate(
        ...
        accession_no.oninput = (e) => {
          ...
          interval = setTimeout(() => {
            ...
            console.log("Accession No :::", accession_no_value);
        ...
        enrollment_no.oninput = (e) => {
          ...
          interval = setTimeout(() => {
            ...
            console.log("Enrollment No :::", enrollment_no_value);
        ...
        console.log("Issue-btn :::", issue_btn);
        ...
        issue_btn.onclick = (e) => {
          ...
          window.BOOKS.issueBook({
            ...
            if (!res.success) {
              console.log("Error Occurred While Issuing Book :", res.error);
            ...
            console.log("data :::", res.book_data);
            console.log("Student Data :::", res.stu_data);
    ...
    if (page == "Return") {
      if (userRole == "librarian") {
        ...
        window.BOOKS.getIssuedBooks().then((res) => {
          ...
          if (!res.data) {
            tbody.innerHTML = "<tr colspan='8'><td> NO DATA FOUND </td></tr>";
          } else {
            tbody.innerHTML = "";
    ...
    if (page == "return_book") {
      if (userRole == "librarian") {
        console.log("Return_Book Clicked :::");
        ...
        return_btn.onclick = (e) => {
          ...
          console.log("ISSUE BUTTON ::::", return_btn);
          console.log("Accession No :::", accession_no_value);
          ...
          window.BOOKS.fileReturn({
            ...
            if (res.error) {
              showMessage(
                "error",
                "Book Not Returned",
                "Book Not Returned Successfully"
              );
            }
          });
        };
    ...
    if (page == "Update_Student") {
      if (userRole == "librarian") {
        console.log("Update_Student page loaded");
        ...
        if (editingStudent) {
          try {
            ...
            console.log("Loading student for editing:", student);
      ...
      row.innerHTML = `
         ...
         <td>
           <span style="display: flex; gap: 5px;">
             <button type="button" class="btn btn-primary" book-data='${JSON.stringify(book)}' id="edit-book-btn">Edit</button>
             <button type="button" class="btn btn-danger delete-book-btn" book_id='${JSON.stringify(book.id)}'>Delete</button>
           </span>
         </td>
  ...
  function editBook(bookData) {
    console.log(":::Book Data Recived in editBook:::", bookData);
  ...
  function deleteBookOrStudent(book_id, stu_id) {
    console.log(":::Book Data Recived in deleteBookOrStudent in Index.js File:::", book_id);
    if (book_id) {
  ...
  function updateBook(bookData, update_btn) {
    console.log(":::Book Data Recived in updateBooks:::", bookData);
  ...
  function displayStudents(data) {
    ...
    console.log(":::DATA Recived in displayStudents:::", data);
    let table_body = document.getElementById("table-body");
    table_body.innerHTML = "";
      ...
      data.forEach((student) => {
        ...
        row.innerHTML = `
         ...
         <td>
           ...
           <button type="button" class="btn btn-danger delete-student-btn" student_id='${JSON.stringify(student.id)}'>Delete</button>
           </td>
           </span>
  ...
  function searchStudents(allstudents) {
    ...
    console.log(":::searchStudents:::", searchInput);
    let searchTimeout; // Store timeout ID for debouncing
    ...
    console.log("progrma is in searchStudents");
  }
